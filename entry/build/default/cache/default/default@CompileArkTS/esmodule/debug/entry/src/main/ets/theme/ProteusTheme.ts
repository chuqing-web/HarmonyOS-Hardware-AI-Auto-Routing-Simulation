...
const PCB_LIGHT: PcbThemePalette = {
    CANVAS_BG: '#000000',
    SUBSTRATE: '#143D28',
    GRID: 'rgba(180,180,180,0.40)',
    GRID_MAJOR: 'rgba(220,220,220,0.65)',
    BOARD_OUTLINE: '#E8A020',
    SILK: '#F0F4FA',
    PAD_SMD: '#FF3333',
    PAD_SMD_NET: '#FF4444',
    PAD_TH: '#E8C040',
...
/**
 * 深色：对齐 KiCad / EasyEDA — 黑底点阵 + 红顶铜 / 绿底铜 + 黄板框
 */
const PCB_DARK: PcbThemePalette = {
    CANVAS_BG: '#000000',
    SUBSTRATE: '#143D28',
    GRID: 'rgba(160,160,160,0.38)',
    GRID_MAJOR: 'rgba(200,200,200,0.62)',
    BOARD_OUTLINE: '#E8A020',
    SILK: '#E8F4FF',
    PAD_SMD: '#FF2A2A',
    PAD_SMD_NET: '#FF4040',
    PAD_TH: '#E8C040',
    PAD_UNCONNECTED: '#707070',
    VIA_FILL: '#C8B860',
    VIA_STROKE: '#F0E890',

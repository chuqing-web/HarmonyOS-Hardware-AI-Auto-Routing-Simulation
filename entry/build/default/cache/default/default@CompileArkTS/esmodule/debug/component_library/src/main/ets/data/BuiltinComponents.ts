    ...
    return [
        {
            ...
            manufacturer: 'Maxim',
            description: '1-Wire 温度传感器（GND/DQ/VDD）；仿真中可拖滑条调节 temp_c',
            pins: pinsDs18b20(),
            defaultParams: params3('range', '-55~125°C', 'interface', '1-Wire', 'temp_c', '25'),
            spiceModel: '',
        ...
        },
        {
            ...
            category: ComponentCategory.SENSOR,
            manufacturer: 'Generic',
            description: '霍尔开关（VCC/OUT/GND）；仿真中点按顶部 MAG ON/OFF 钮切换磁场',
            pins: pinsHallSensor(),
            defaultParams: params2('type', 'digital', 'active', '0'),
            spiceModel: '',
            behaviorModel: 'hall',
            svgSymbol: 'hall.svg',
...
function makeVirtualMeter(): ComponentDefinition {
    const def: ComponentDefinition = {
        ...
        category: ComponentCategory.INSTRUMENT,
        manufacturer: 'AI-SCH',
        description: '四端万用表：V(电压)/A(电流)/OHM(电阻·二极管)/COM',
        pins: [
            makePin('V', 'V', '1', PinType.INPUT, -30, -30),
            makePin('A', 'A', '2', PinType.INPUT, -30, -10),
            makePin('OHM', 'OHM', '3', PinType.INPUT, -30, 10),
            makePin('COM', 'COM', '4', PinType.GROUND, -30, 30)
        ],
        defaultParams: params1('modes', 'DCV,ACV,OHM,AMP,DIODE'),
        spiceModel: '',
